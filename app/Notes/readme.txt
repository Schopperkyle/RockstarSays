...
Description: Rockstar Says is an app with similar functionality to that of the classic game Simon Says.
             The game starts by playing music and highlighting randomly one out of four buttons on the
             screen; each button has a different color (red, blue, yellow and green). The user should
